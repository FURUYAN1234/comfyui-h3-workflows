...
専用リポジトリのタグ v1.2.0-ref1 をクリーンに取得します。Python標準ライブラリだけで再構築できます。

```text
git clone --branch v1.2.0-ref1 --depth 1 https://github.com/FURUYAN1234/comfyui-h3-workflows.git h3-source
cd h3-source
python -B build_release.py ../H3_T2V-I2V-Ref2V-MV_20260926115639_v1.2.0-ref1.zip
```
