...
- `workflows/`：`T2V_4step_20260909161623_v1.1.3.json`、`I2V_4step_20260909161623_v1.1.3.json`、`Ref2V_4step_20260909161623_v1.1.3.json`の3種類。サンプル日本語だけを入力済み。各ワークフロー内にも詳しい説明があります。
