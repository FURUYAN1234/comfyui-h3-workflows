...
- `workflows/`：`T2V_4step_20260909123500_v1.1.1.json`、`I2V_4step_20260909123500_v1.1.1.json`、`Ref2V_4step_20260909123500_v1.1.1.json`の3種類。サンプル日本語だけを入力済み。各ワークフロー内にも詳しい説明があります。
