...
- `workflows/`：`T2V_4step_20260909120243_v1.1.0.json`、`I2V_4step_20260909120243_v1.1.0.json`、`Ref2V_4step_20260909120243_v1.1.0.json`の3種類。サンプル日本語だけを入力済み。各ワークフロー内にも詳しい説明があります。
