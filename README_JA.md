...
- `workflows/`：`T2V_4step_20260909141419_v1.1.2.json`、`I2V_4step_20260909141419_v1.1.2.json`、`Ref2V_4step_20260909141419_v1.1.2.json`の3種類。サンプル日本語だけを入力済み。各ワークフロー内にも詳しい説明があります。
